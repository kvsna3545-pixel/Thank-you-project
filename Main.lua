...
wait(2) 
print("Loading script Thank you Project Gui v11.1") 
wait(3) 
...
wait(10) 
print(" d888b  db    db d888888b      .d888b.      db      db    db  .d8b. ")
wait(1)
print("88' Y8b 88    88   `88'        VP  `8D      88      88    88 d8' `8b")
wait(1)
print("88      88    88    88            odD'      88      88    88 88ooo88")
wait(1)
print("88  ooo 88    88    88          .88'        88      88    88 88~~~88")
wait(1)
print("88. ~8~ 88b  d88   .88.        j88.         88booo. 88b  d88 88   88")
wait(1)
print(" Y888P  ~Y8888P' Y888888P      888888D      Y88888P ~Y8888P' YP   YP")
wait(1)
print("script by kvsna3545")
wait(4)
print("Let's go bro")
wait(0.8)
...
local scripts = {
    ...
    {"NAME SCRIPT", "a"},
    {"NAME SCRIPT", "a"},
    {"ThankyouProject by kvsna3545", "a"},
}
